musicApp.service('allNotes', function (Note) {
    ...
    var pad2 = new Note('pad2', 50, 'repeat', './MusicSections/popCulture/aroundTheWorld.mp3');
    ...
    var pad5 = new Note('pad5', 53, 'gate', './MusicSections/popCulture/boysAndGirls.mp3');
    ...
    var pad8 = new Note('pad8', 56, 'repeat', './MusicSections/popCulture/dare.mp3');
    var pad9 = new Note('pad9', 57, 'toggle', './MusicSections/popCulture/drumRiff.mp3');
    var pad0 = new Note('pad0', 48, 'trigger', './MusicSections/popCulture/heavyCross.mp3');
    var padDash = new Note('padDash', 189, 'trigger', './MusicSections/popCulture/ho.mp3');
    var padEquals = new Note('padEquals', 187, 'trigger', './MusicSections/popCulture/hungOut.mp3');
